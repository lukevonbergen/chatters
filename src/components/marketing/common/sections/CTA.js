  ...
  return (
    <section className="py-12 lg:py-16 px-4 lg:px-6">
      <div className="max-w-[1400px] mx-auto">
        <div 
          className="relative overflow-hidden rounded-2xl lg:rounded-3xl border border-gray-200 
            bg-gradient-to-br from-green-50 via-white to-blue-50"
          style={{
            boxShadow: "0 0 20px rgba(0,0,0,0.08)" // centered glow
          }}
        >
          ...
          {/* Content - now flex row */}
          <div className="relative flex flex-col lg:flex-row items-center lg:items-center justify-between px-8 lg:px-12 py-8 lg:py-10">
            {/* Text on the left */}
