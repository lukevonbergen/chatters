      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Business integration</p>
              </div>
            </div>
            {googleConnected ? (
          ...
          <div className="text-sm text-gray-600">
            {googleConnected ? (
              <>
                <p className="mb-2">✅ Google Business listing is connected</p>
                <p>Your Google reviews are being tracked automatically.</p>
              </>
            ) : (
              <>
                <p className="mb-3">Connect your Google Business listing to:</p>
                <ul className="space-y-1 text-xs mb-4">
                  <li>• Track Google reviews automatically</li>
                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500">Start typing to search for your Google Business listing</p>
                </div>
              </>
            )}
          </div>
