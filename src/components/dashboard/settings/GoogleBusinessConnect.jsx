    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6">
      ...
      <div className="text-sm text-gray-600">
        {isConnected ? (
            ...
            <div className="space-y-3">
              ...
              {canManageConnection && (
                <button
                  ...
                  className="w-full mt-4 px-4 py-2 border border-red-300 text-red-700 rounded-lg hover:bg-red-50 transition-colors text-sm font-medium"
                >
                  Disconnect Google
                </button>
              )}
          ...
          <>
            <p className="mb-3">Connect your Google Business Profile to:</p>
            ...
            {canManageConnection ? (
              <button
                ...
                disabled={connecting}
                className="w-full mt-4 px-4 py-3 bg-custom-black text-white rounded-lg hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium flex items-center justify-center gap-2"
              >
                {connecting ? (
                  <>
