      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h4 className="font-semibold text-primary mb-3 text-lg">Upload Your Logo</h4>
                  <p className="text-gray-700 mb-4">
                    Your logo appears on feedback forms, QR codes, and customer-facing materials.
                  </p>

                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                    <h5 className="font-semibold text-primary mb-2">Logo Requirements:</h5>
                    <ul className="space-y-2 text-gray-700 text-sm">
                      <li>• <strong>Format:</strong> PNG, JPG, or SVG</li>
                      <li>• <strong>Size:</strong> Recommended 400x160 pixels (2.5:1 ratio)</li>
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    ...
                    <ul className="space-y-1 text-gray-700 text-sm">
                      <li>• Use a high-resolution image to avoid pixelation</li>
            ...
            {/* Brand Colors */}
            <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
              <h4 className="font-semibold text-primary mb-3 text-lg">Set Brand Colors</h4>
              <p className="text-gray-700 mb-4">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block font-semibold text-primary mb-2">Primary Color</label>
                  <p className="text-sm text-gray-600 mb-3">
                    Used for buttons, headers, and key interactive elements
                  </p>
                  <div className="flex items-center space-x-3">
                    <div className="w-16 h-16 bg-green-600 rounded-lg border-2 border-gray-300"></div>
                    <div>
                      <p className="text-sm text-gray-600">Example: #16A34A</p>
                      <p className="text-xs text-gray-500">Your brand's main color</p>
                    </div>
                  </div>
                </div>

                <div>
                  <label className="block font-semibold text-primary mb-2">Secondary Color</label>
                  <p className="text-sm text-gray-600 mb-3">
                    Used for backgrounds, borders, and subtle accents
                  </p>
                  <div className="flex items-center space-x-3">
                    <div className="w-16 h-16 bg-blue-100 rounded-lg border-2 border-gray-300"></div>
                    <div>
                      <p className="text-sm text-gray-600">Example: #DBEAFE</p>
                      <p className="text-xs text-gray-500">Complementary color</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <p className="text-sm text-gray-700">
                  <strong>Note:</strong> Changes to brand colors update immediately on all feedback forms and customer-facing pages.
                </p>
              </div>
            </div>
